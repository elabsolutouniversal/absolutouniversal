...
export interface PenduloData {
  ...
  benefitsSection: {
    title: string;
    iconType?: 'healing' | 'distance' | 'time' | 'space' | 'default'; // ← AGREGADO
...
export const penduloData: PenduloData = {
  ...
  mainImage: "/images/pendulo-main.jpg",
  benefitsSection: {
    title: "¿Para qué sirve el péndulo hebreo?",
    iconType: "healing", // ← AGREGADO - Estrella rosa fuerte
    sideImage: "/images/pendulo-side.jpg",
    benefits: [
  ...
  accordionSections: [
    {
      ...
      iconType: "time" // ← CAMBIADO de "healing" a "default" - Estrella rosa clara
    },
    {
      id: "tratamiento-distancia",
      title: "¿Qué es el tratamiento a distancia con el Péndulo Hebreo?",
      content: "La energía se dirige a intención la fuerza, sin las limitaciones de tiempo y espacio, como ha demostrado la física cuántica. El tratamiento a distancia se realiza siempre con el permiso de la persona que deseará la liberación y se responsabilizará de leer siempre. Cuando el tratamiento se presencial, el receptor se encuentra fijando cómodamente sobre una camilla de masaje.",
      iconType: "distance"
    },
    {
      id: "duracion-tratamiento",
      title: "¿Cuánto dura un tratamiento con el Péndulo Hebreo?",
      content: "Un tratamiento dura en promedio entre 1 hora 30 y 2 horas. Es recomendable recibir 3 tratamientos seguidos para potenciar los efectos, aunque desde el primero ya se sienten beneficios. Nota: Esta terapia es complementaria y no reemplaza el seguimiento médico o terapéutico tradicional.",
      iconType: "time"
    },
    {
      id: "limpieza-lugares",
      title: "Limpieza, Purificación y Armonización de los Lugares",
      content: "Purificar tu hogar o lugar de trabajo es fundamental para eliminar energías negativas y renovar el ambiente. La limpieza energética permite a los habitantes vivir mejor, liberarse de enfermedades físicas, dolores inexplicables, trastornos emocionales y del sueño. Se recomienda hacerlo regularmente o cada vez que la intuición lo sugiera.",
      iconType: "space"
    }
  ],
  ctaButton: {
    text: "Agenda tu sesión por WhatsApp",
    link: "https://wa.me/1234567890" // ← Reemplaza con tu número real
  }
};
...
export const galleryData: GalleryData = {
  ...
  images: [
    ...
    },
    {
      ...
      alt: "Terapia Integrativa Holística - Sesión 2",
