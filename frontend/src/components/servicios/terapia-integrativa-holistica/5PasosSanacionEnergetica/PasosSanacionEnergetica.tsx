...
const SanacionEnergetica = () => {
  ...
  return (
    ...
    <section className="bg-gradient-to-br from-amber-50/50 via-stone-50 to-orange-50/30 rounded-2xl md:rounded-3xl p-4 sm:p-6 md:p-8 lg:p-12">
      ...
      >
        ...
        <div className="inline-flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-full bg-gradient-to-r from-orange-400 to-orange-600 mb-4 md:mb-6">
          <Sparkles className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-white" />
        </div>
        <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-brand-dark mb-3 md:mb-4 leading-tight">
      ...
      >
                 <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-brand-dark mb-2 px-2">
           ¿Qué Incluye tu Tratamiento?
         </h3>
        <div className="w-20 sm:w-24 h-1 bg-gradient-to-r from-orange-400 to-orange-600 mx-auto rounded-full" />
      </motion.div>
      ...
      >
        {sesiones.map((sesion, i) => {
          ...
          return (
            ...
            >
                             <div className="bg-white rounded-xl md:rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden border border-brand-light/20">
                  ...
                  <div className="flex flex-col space-y-4 md:flex-row md:items-start md:gap-6 md:space-y-0">
                    <div className="flex items-center justify-center md:flex-col md:flex-shrink-0">
                      ...
                      >
                        <Icon className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8" />
                         ...
                         <span className="text-lg sm:text-xl md:text-2xl font-bold text-brand-medium">
                           {sesion.numero}
                         </span>
                       </div>
                    </div>
                    <div className="flex-1">
                      <div className="space-y-3 md:space-y-0 md:flex md:items-center md:justify-between mb-4">
                                                 <h4 className="text-base sm:text-lg md:text-xl font-bold text-brand-dark leading-tight">
                           Sesión {sesion.numero}: {sesion.titulo}
                         </h4>
                         <div className="flex items-center justify-between md:justify-start gap-3">
                           {sesion.badge && (
                             <span className="bg-gradient-to-r from-orange-400 to-orange-600 text-white px-2 py-1 sm:px-3 rounded-full text-xs sm:text-sm font-semibold">
                               {sesion.badge}
                             </span>
                           )}
                      ...
                      <div className="space-y-2 md:space-y-3">
                           ...
                           <div key={j} className="flex items-start gap-2 md:gap-3">
                             <CheckCircle className="w-4 h-4 md:w-5 md:h-5 text-brand-light flex-shrink-0 mt-0.5" />
                             <span className="text-brand-medium leading-relaxed text-xs sm:text-sm md:text-base">
                               {p}
                             </span>
                           </div>
                         ))}
      ...
      <section className='mt-10 text-center text-2xl sm:text-3xl md:text-4xl font-bold text-brand-dark mb-4 md:mb-6'>
    

        <div className="text-center mt-10">
          <h2 className='text-3xl sm:text-3xl md:text-4xl font-bold text-brand-dark mb-4 md:mb-6'>Tratamiento Personalizado</h2>
          <p className='text-brand-medium leading-relaxed text-xl text-justify font-medium m-10'>
      ...
      >
        <div className="relative overflow-hidden rounded-xl md:rounded-2xl p-5 sm:p-6 md:p-8">
          <div
          ...
          <div className="relative z-10">
            <h3 className="text-lg sm:text-xl md:text-2xl font-lora-bold text-brand-dark mb-2 md:mb-3">
              ¿Listo para Iniciar el camino hacia tu maximo bienestar?
            </h3>
            <p className="text-sm sm:text-base md:text-lg mb-5 md:mb-6 text-brand-medium max-w-2xl mx-auto leading-relaxed px-2">
            ...
            <Link
              ...
              className="
                ...
                shadow-lg shadow-orange-300/50 hover:shadow-xl
