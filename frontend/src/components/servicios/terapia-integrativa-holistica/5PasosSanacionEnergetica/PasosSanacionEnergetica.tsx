...
const SanacionEnergetica = () => {
  ...
  return (
    <section className="bg-gradient-to-br from-purple-50 via-blue-50 to-indigo-100 rounded-2xl md:rounded-3xl p-4 sm:p-6 md:p-8 lg:p-12">
      ...
      >
        {/* Ícono principal - tamaños responsive */}
        ...
        {/* Título principal - escalado móvil */}
        ...
        {/* Subtítulo - mejor legibilidad móvil */}
      ...
      {/* 🔹 TÍTULO DE SESIONES - Spacing móvil */}
      <motion.div
        initial={{ opacity: 0, y: 20 }}
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true }}
      ...
      >
        {sesiones.map((sesion, index) => {
          ...
          return (
            ...
            >
              {/* 🔹 TARJETA - Layout móvil optimizado */}
      ...
      {/* 🔹 CALL TO ACTION - Optimizado para móvil */}
      <motion.div
        initial={{ opacity: 0, y: 20 }}
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true }}
      ...
      >
        <div className="bg-gradient-to-r from-purple-600 to-pink-600 rounded-xl md:rounded-2xl p-5 sm:p-6 md:p-8 text-white">
          ...
          {/* 🔹 BOTÓN - Totalmente optimizado para móvil */}
          <button className="
            w-full sm:w-auto
