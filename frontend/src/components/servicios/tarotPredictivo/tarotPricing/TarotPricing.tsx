...
export default function TarotPricing() {
  return (
    <section className="py-16 md:py-24 px-4 bg-gradient-to-b from-stone-50 via-amber-50/40 to-orange-50/20">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12 md:mb-16">
          ...
          <p className="text-lg md:text-xl text-brand-medium max-w-2xl mx-auto">
