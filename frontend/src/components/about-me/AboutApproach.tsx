    ...
    <section className="py-16 md:py-24 bg-gradient-to-b from-stone-50 via-amber-50/40 to-orange-50/20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-12 text-center">
          ...
          <h3
            className="text-3xl font-bold text-brand-medium mt-2 mb-8"
        ...
        <div className="grid gap-8 lg:grid-cols-3">
          ...
          <div className="group relative overflow-hidden rounded-2xl bg-white p-8 shadow-lg transition-all hover:shadow-xl">
            ...
            <div className="relative">
              ...
              <h4 className="mb-4 text-xl font-bold text-brand-dark">{approach.dimensions.scientific.title}</h4>
          ...
          <div className="group relative overflow-hidden rounded-2xl bg-white p-8 shadow-lg transition-all hover:shadow-xl">
            ...
            <div className="relative">
              ...
              <h4 className="mb-4 text-xl font-bold text-brand-dark">{approach.dimensions.transpersonal.title}</h4>
              <ul className="space-y-3">
          ...
          <div className="group relative overflow-hidden rounded-2xl bg-white p-8 shadow-lg transition-all hover:shadow-xl">
            ...
            <div className="relative">
              ...
              <h4 className="mb-4 text-xl font-bold text-brand-dark">{approach.dimensions.integrative.title}</h4>
              <ul className="space-y-3">
