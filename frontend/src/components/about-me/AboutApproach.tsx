        ...
        <div className="grid gap-8 lg:grid-cols-3">
          ...
          <div className="group relative overflow-hidden rounded-2xl bg-white p-8 shadow-lg transition-all hover:shadow-xl">
            ...
            <div className="relative">
              ...
              <h4 className="mb-4 text-xl font-bold text-purple-800">{approach.dimensions.scientific.title}</h4>
          ...
          <div className="group relative overflow-hidden rounded-2xl bg-white p-8 shadow-lg transition-all hover:shadow-xl">
            ...
            <div className="relative">
              ...
              <h4 className="mb-4 text-xl font-bold text-purple-800">{approach.dimensions.transpersonal.title}</h4>
              <ul className="space-y-3">
          ...
          <div className="group relative overflow-hidden rounded-2xl bg-white p-8 shadow-lg transition-all hover:shadow-xl">
            ...
            <div className="relative">
              ...
              <h4 className="mb-4 text-xl font-bold text-purple-800">{approach.dimensions.integrative.title}</h4>
              <ul className="space-y-3">
