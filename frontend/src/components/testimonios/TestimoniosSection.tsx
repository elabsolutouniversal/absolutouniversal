    ...
    return (
      <section className={`py-16 bg-gradient-to-b from-pink-50 via-rose-50 to-purple-50 ${className}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">No hay testimonios disponibles</h2>
          <p className="text-gray-700">Sé el primero en compartir tu experiencia con nosotros.</p>
        </div>
      </section>
    );
  }
    ...
    <section className={`py-16 bg-gradient-to-b from-pink-50 via-rose-50 to-purple-50 ${className}`}>      
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center justify-center mb-6 px-5 py-2 bg-white/90 backdrop-blur-sm rounded-full border border-pink-200 shadow-sm">
            <Sparkles className="w-6 h-6 text-pink-600 mr-2" />
            <span className="text-pink-600 font-bold text-base uppercase">Testimonios</span>
          </div>

          <h2 className="text-5xl md:text-6xl lg:text-7xl font-extrabold bg-gradient-to-r from-pink-600 via-purple-600 to-pink-700 bg-clip-text text-transparent mb-6 leading-tight">
            {title}
          </h2>
          ...
          <div className="flex items-center justify-center mt-12 space-x-12">
            <div className="text-center group">
              <div className="text-4xl md:text-5xl font-extrabold bg-gradient-to-r from-pink-600 to-purple-600 bg-clip-text text-transparent group-hover:scale-105 transition-transform">
                {testimonios.length}+
              </div>
              <div className="text-base font-semibold text-pink-600 mt-2">Testimonios</div>
            </div>

            <div className="h-12 w-px bg-gradient-to-b from-pink-300 to-purple-300" />

            <div className="text-center group">
              <div className="text-4xl md:text-5xl font-extrabold bg-gradient-to-r from-pink-600 to-purple-600 bg-clip-text text-transparent group-hover:scale-105 transition-transform">
                {ratingPromedio}★
              </div>
              <div className="text-base font-semibold text-pink-600 mt-2">Calificación promedio</div>
            </div>
          </div>
        </div>
